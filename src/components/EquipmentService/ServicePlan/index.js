 ...
 * 维修计划
 */
class ServicePlanMain extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      visible: false,
            ...
            <Form>
              <Row>
                ...
                <Col span={12}>
                  <Row>
                    <Col span={14}>
                      <Form.Item label="维修周期" labelCol={{ span: 10 }} wrapperCol={{ span: 12 }}>
...
const ServicePlan = Form.create()(ServicePlanMain);
